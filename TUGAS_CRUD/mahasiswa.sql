...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Mar 2023 pada 13.23
...
INSERT INTO `mahasiswa` (`id_student`, `nrp`, `nama`, `jenis_kelamin`, `jurusan`, `email_student`, `alamat`, `no_hp`, `asal_sma`, `matkul_favorit`) VALUES
...
(26, '3122500026', 'Shofira Izza Nurrohmah', 'Perempuan', 'D3 Teknik Informatika', 'shofi@it.student.pens.ac.id', 'Ngawi', '085608295984', 'MAN 2 Kota Madiun', 'Workshop Pemrograman Web'),
...
--
ALTER TABLE `mahasiswa`
  MODIFY `id_student` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
COMMIT;
